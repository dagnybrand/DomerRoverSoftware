...
: ${AMENT_CURRENT_PREFIX:="/home/michael/DomerRoverSoftware/src/install/testarm"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/testarm/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/testarm/environment/path.sh"
